...
The release must pass formatting, linting, Astro and TypeScript diagnostics, all unit tests, the production build, document verification, public-output and budget validation, all cross-browser Playwright journeys and Lighthouse budgets before merge and GitHub Pages publication.
